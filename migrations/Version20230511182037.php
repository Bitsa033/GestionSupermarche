 ...
 */
final class Version20230511182037 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE capacite_magasin (id INT AUTO_INCREMENT NOT NULL, magasin_id INT NOT NULL, nb_initial INT NOT NULL, nb_actuel INT NOT NULL, INDEX IDX_E63BCACA20096AE3 (magasin_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reception (id INT AUTO_INCREMENT NOT NULL, commande_id INT NOT NULL, magasin_id INT NOT NULL, qte BIGINT NOT NULL, date_reception DATETIME NOT NULL, prix_total DOUBLE PRECISION NOT NULL, INDEX IDX_50D6852F82EA2E54 (commande_id), INDEX IDX_50D6852F20096AE3 (magasin_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE stock (id INT AUTO_INCREMENT NOT NULL, reception_id INT NOT NULL, qte_init BIGINT NOT NULL, qte_tot BIGINT NOT NULL, prix_total BIGINT NOT NULL, profit_unitaire BIGINT NOT NULL, profit_total BIGINT NOT NULL, date_stockage DATETIME NOT NULL, INDEX IDX_4B3656607C14DF52 (reception_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie_stock DROP FOREIGN KEY FK_D238F364DCD6110');
