 ...
 */
final class Version20230516165923 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, famille_id INT DEFAULT NULL, unite_achat_id INT NOT NULL, unite_vente_id INT NOT NULL, nom VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, prix_achat DOUBLE PRECISION NOT NULL, prix_vente DOUBLE PRECISION NOT NULL, qte_en_stock BIGINT DEFAULT NULL, statut VARCHAR(5) NOT NULL, UNIQUE INDEX UNIQ_29A5EC276C6E55B5 (nom), INDEX IDX_29A5EC2797A77B84 (famille_id), INDEX IDX_29A5EC27B1F04A04 (unite_achat_id), INDEX IDX_29A5EC2732A28C19 (unite_vente_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE stock (id INT AUTO_INCREMENT NOT NULL, reception_id INT NOT NULL, qte_init BIGINT NOT NULL, qte_tot BIGINT NOT NULL, prix_total BIGINT NOT NULL, date_stockage DATETIME NOT NULL, INDEX IDX_4B3656607C14DF52 (reception_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
